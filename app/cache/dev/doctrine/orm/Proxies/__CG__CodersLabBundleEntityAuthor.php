...
namespace Proxies\__CG__\CodersLabBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Author extends \CodersLabBundle\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CodersLabBundle\\Entity\\Author' . "\0" . 'id', '' . "\0" . 'CodersLabBundle\\Entity\\Author' . "\0" . 'name', '' . "\0" . 'CodersLabBundle\\Entity\\Author' . "\0" . 'surname', '' . "\0" . 'CodersLabBundle\\Entity\\Author' . "\0" . 'description', '' . "\0" . 'CodersLabBundle\\Entity\\Author' . "\0" . 'books');
        }
